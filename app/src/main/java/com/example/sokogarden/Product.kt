...
class ProductAdapter(private val productList: List<Product>) :
    ...
    //Access the Layout - Single Item Used to inflate/ attach details.
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        val imageUrl = "https://collinspaul.alwaysdata.net/static/images/${product.product_photo}"
 
        //Load image (on device) using Glide, Load Faster with Glide
        Glide.with(holder.itemView.context)
            ...
            .into(holder.imgProduct)
                ...
                holder.btnPurchase.setOnClickListener {
                    ...
                    // Explicit intent opening the Payment Page of the app
                    val intent = android.content.Intent(context, PaymentActivity::class.java).apply {
                        // putExtra - Allows for the movement of the product details from the Main Page to the Payment Activity when the Purchase Now button is pressed
    ...
    // Counts the number of items retrieved from database.
